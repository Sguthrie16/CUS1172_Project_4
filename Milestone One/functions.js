...
// Async await - Getting data from quiz
  let get_api_data = async (api_endpoint) =>{
    ...
    data = await results.json()
      ...
      generate_quiz_one(data,current_question,number_of_questions,question_type);
}
function generate_quiz_one(data,current_question,number_of_questions,question_type){
